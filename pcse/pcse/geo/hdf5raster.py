...
class Hdf5Raster(GridEnvelope2D):
    ...
    def readheader(self):
        # TODO if all information from the header is stored in the file itself, this method will be redundant
    ...
    def writeheader(self):
        # TODO store all this information in the hdf5 file itself
