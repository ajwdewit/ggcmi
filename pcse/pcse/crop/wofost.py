...
from .agromet_indicators import AgroMetIndicators
...
class Wofost(SimulationObject):
    ...
    **State variables:**
    ...
    agromet_indicators = Instance(SimulationObject)
    ...
    def initialize(self, day, kiosk, cropdata, soildata, sitedata,
        ...
        self.agromet_indicators = AgroMetIndicators(day, kiosk, {})
    ...
    def calc_rates(self, day, drv):
        ...
        self.agromet_indicators.calc_rates(day, drv)
