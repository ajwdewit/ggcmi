** $Id: totass.for 1.2 1997/10/02 15:20:35 LEM release $
...
Cf2py intent(in) dayl, amax, eff, lai, kdif, avrad, diffpp, dsinbe
Cf2py intent(in) sinld, cosld
Cf2py intent(out) dtga
